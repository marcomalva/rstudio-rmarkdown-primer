...
> Not all table output is available in the `github_document` output format which is why I had to enable `always_allow_html`.
> The output could be improved by installing webshot packages but that is currently beyond the scope of this document.
> For now, for best output, select `html_document`.
